...
var _logChopper = require('log-chopper');

var _logChopper2 = _interopRequireDefault(_logChopper);
...
class Updater {
    ...
    this._catch(() => {
      if (_fsExtra2.default.existsSync(dir)) {
        _fsExtra2.default.readdirSync(dir).forEach(d => {
          ...
          if ((0, _moment2.default)(_fsExtra2.default.statSync(dirs.dir).mtime).isBefore((0, _moment2.default)().subtract(24, 'hours'))) {
            this._cleanupDirs(dirs);
          } else {
  ...
  get autoupdateNeeded() {
    try {
      const stat = _fsExtra2.default.statSync(this.autoupdatefile);
      return (0, _moment2.default)(stat.mtime).isBefore((0, _moment2.default)().subtract(5, 'hours'));
    } catch (err) {
  ...
  async autoupdate() {
    try {
      ...
      _fsExtra2.default.writeFileSync(this.autoupdatefile, '');
      ...
      spawn(this.binPath, ['update'], { stdio: [null, fd, fd] }).on('error', e => this.out.warn(e, 'autoupdate:'));
    } catch (e) {
      this.out.warn(e, 'autoupdate:');
    }
    try {
      await _logChopper2.default.chop(this.out.errlog);
    } catch (e) {
