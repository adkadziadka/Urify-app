...
class LinkedPlugins extends _manager.Manager {
  ...
  _save() {
    _fsExtra2.default.writeJSONSync(this.file, this._data);
  }
  ...
  _needsPrepare(p, main) {
    ...
    return !!(0, _klawSync2.default)(p, { nodir: true, ignore: '{node_modules,.git}' }).filter(f => f.path.endsWith('.js')).find(f => f.stats.mtime > this._data.updated_at);
  }
